...
* [9.5.0](https://github.com/Gurobi/docker-python/blob/master/9.5.0/Dockerfile) Gurobi with Python 3.8, other Gurobi supported versions are gurobi/python:9.5.0_(3.7, 3.9 and 3.10) 
